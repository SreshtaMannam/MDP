...
def set_bg_from_url(url, opacity=1):
    ...
    <div style='visibility: visible;margin-top:7rem;justify-content:center;display:flex;'>
        <p style="font-size:1.1rem;">
            By IT 06
            &nbsp;
            <a href="https://github.com/SreshtaMannam/Multiple-Disease-Prediction---MachineLearning-using-streamlit" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="white" class="bi bi-github" viewBox="0 0 16 16" style="fill: white;">
